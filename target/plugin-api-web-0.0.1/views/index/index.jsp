...
<html lang="pt">
              ...
              <ul class="nav">
                ...
                <li class="dropdown">
                  ...
                  <ul class="dropdown-menu">
                    <li><a href="/athena/plugin">Plugin API</a></li>
    ...
    <div id="myCarousel" class="carousel slide" style="margin-bottom: 30px;">
      <div class="carousel-inner">
        <div class="item active">
          <img src="/athena/img/examples/slide-01.jpg" alt="">
          <div class="container">
        ...
        <div class="item">
          <img src="/athena/img/examples/slide-02.jpg" alt="">
          <div class="container">
            <div class="carousel-caption">
        ...
        <div class="item">
          <img src="/athena/img/examples/slide-03.jpg" alt="">
          <div class="container">
            <div class="carousel-caption">
              <h1>Modularização</h1>
              <p class="lead">Cras justo odio, dapibus ac facilisis in, egestas eget quam. Donec id elit non mi porta gravida at eget metus. Nullam id dolor id nibh ultricies vehicula ut id elit.</p>
    ...
    <div class="container marketing">
      ...
      <div class="row">
        <div class="span4">
          	<img class="img-rounded" src="/athena/img/home/ia.jpg" style="width: 210px;">
        ...
        <div class="span4">
          <img class="img-rounded" src="/athena/img/home/cloud-computing.png" style="width: 250px;">
        ...
        <div class="span4">
          <img class="img-rounded" src="/athena/img/home/modulo.png" style="width: 195px;">
