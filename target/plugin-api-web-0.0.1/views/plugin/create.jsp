...
<html lang="pt">
    ...
    <div class="container marketing" style="margin-top: 100px;">
    	...
    	<div class="content">
			<div id="center" class="container_mid" style="display: block;">
				<div class="row">
			      	<div class="span2"></div>
			        <div class="span8">
			        	<div class="well">
			        		<form action="" class="form-horizontal">
			        			<fieldset>
			        				<legend>Cadastrar Novo Plugin</legend>
				        			<div class="control-group">
									    <label class="control-label" for="pluginName">Nome do Plugin</label>
									    <div class="controls">
									      <input type="text" id="pluginName" placeholder="Nome do Plugin">
									    </div>
									  </div>
									  <div class="control-group">
									    <label class="control-label" for="pluginDescription">Descrição do Plugin</label>
									    <div class="controls">
									      <textarea rows="3"></textarea>
									    </div>
									  </div>
									  <div class="control-group">
									  	<label class="control-label" for="pluginFile">Arquivo do Plugin</label>
									  	<div class="controls">
											<div class="input-append">
											  <input id="appendedInputButton" type="text">
											  <button class="btn" type="button"><i class="icon-folder-open"></i> Carregar Plugin . . .</button>
											</div>
										</div>
									  </div>
    ...
    <script src="/athena/js/bootstrap-transition.js"></script>
    ...
    <script src="/athena/js/bootstrap-scrollspy.js"></script>
    <script src="/athena/js/bootstrap-tab.js"></script>
    <script src="/athena/js/bootstrap-tooltip.js"></script>
    <script src="/athena/js/bootstrap-popover.js"></script>
    <script src="/athena/js/bootstrap-button.js"></script>
    <script src="/athena/js/bootstrap-collapse.js"></script>
    <script src="/athena/js/bootstrap-carousel.js"></script>
    <script src="/athena/js/bootstrap-typeahead.js"></script>
